...
# @Description : automount/autofs 서비스를 비활성화
...
BEFORE_SETTING="$AUTOFS_SERVICES"
...
AFTER_SETTING="automount/autofs 서비스 비활성화 완료"
[ -z "$ACTION_LOG" ] && ACTION_LOG="automount/autofs 서비스가 이미 비활성화 상태"
